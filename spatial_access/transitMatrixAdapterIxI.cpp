...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_pyTransitMatrix, (PyObject *)&__pyx_type_14spatial_access_23transitMatrixAdapterIxI_pyTransitMatrix) < 0) __PYX_ERR(1, 51, __pyx_L1_error)
