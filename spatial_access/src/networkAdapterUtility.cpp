...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_pyNetworkUtility, (PyObject *)&__pyx_type_21networkAdapterUtility_pyNetworkUtility) < 0) __PYX_ERR(1, 15, __pyx_L1_error)
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_networkAdapterUtility(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'networkAdapterUtility' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init networkAdapterUtility", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
