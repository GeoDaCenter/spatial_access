...
int main()
{
    ...
    transitMatrix<unsigned long int, unsigned long int, unsigned short> matrix(false, false, num_sources, num_dests);
    ...
    transitMatrix<std::string, std::string, unsigned short> tm2;
